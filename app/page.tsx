    ...
    <>
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start w-full max-w-[1200px] mx-auto">
        ...
        <p className="text-lg text-slate-300 pb-10">
          ...
          jakość i szybki czas realizacji. Nasz wykwalifikowany zespół techników
          jest gotowy pomóc zarówno klientom indywidualnym, jak i firmom, dbając
          o to, aby każdy sprzęt działał sprawnie i bez zakłóceń. Oprócz
          serwisu, w naszym sklepie znajdziesz szeroki wybór komputerów,
          laptopów i podzespołów, idealnych dla różnych potrzeb - od codziennego
          użytku po wymagające zadania biznesowe.
        </p>
        ...
        <p className="text-lg text-slate-300 pb-10">
          W FixIT dbamy o to, aby nasz asortyment był zawsze dostępny i
          odpowiadał na potrzeby naszych klientów. Regularnie uzupełniamy stany
          magazynowe, aby zapewnić szeroki wybór najnowszych modeli komputerów,
          laptopów oraz akcesoriów. Dzięki współpracy z renomowanymi dostawcami,
          jesteśmy w stanie szybko sprowadzić produkty, które cieszą się dużym
